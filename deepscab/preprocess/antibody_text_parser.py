...
def get_info(pdb_file, fasta_file=None, verbose=True):
    ...
    pairwise_geometry_mat = protein_pairwise_geometry_matrix(
        pdb_file, fasta_file=fasta_file)
    phi_psi_mat = protein_bb_phi_psi_matrix(pdb_file)
    chi_one_mat, chi_two_mat, chi_three_mat, chi_four_mat, chi_five_mat = protein_chi_matrix(
        pdb_file)
    ...
    info.update(
        dict(dist_angle_mat=dist_angle_mat,
             pairwise_geometry_mat=pairwise_geometry_mat,
             phi_psi_mat=phi_psi_mat,
             chi_one_mat=chi_one_mat,
             chi_two_mat=chi_two_mat,
             chi_three_mat=chi_three_mat,
             chi_four_mat=chi_four_mat,
             chi_five_mat=chi_five_mat,
             id=id_))
    return info
